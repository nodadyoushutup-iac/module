resource "spacelift_stack" "stack" {
  ...
  branch = var.branch != null && var.branch != "" ? var.branch : (try(local.config.global.stack.branch, null) != null && try(local.config.global.stack.branch != "", "") ? local.config.global.stack.branch : "main")
